...
if(isset($_POST['action']) && $_POST['action'] == "registar")
{
	...
	if($user_object->save_data()) {
            ...
            <p style="text-align:center">Este é o email de verificação, por favor click no link abaixo para activar o seu registo.</p>
             <a href="https://98ed-41-220-201-124.ngrok-free.app/Plus_vendas/plus_vendas/verify.php?code='.$user_object->getUserVerificationCode().'">Clique aqui para verificar</a>
              <p><h3>Obrigado!</h3></p>
